...
PARAMS = {
    "clustering_method": [
        ...
        cluster_method.ward_clustering,
    ],
    "correlation_network": [
    ...
    "multivariate_distribution": [
        ...
        multivariate_distribution.mixture_distribution,
    ],
    "number_clusters": [2, 4, 6],
    "sample_size_of_observations": [40, 100, 500],
}
...
PARAMS_NAME = {
    ...
    "correlation_network": ["Pearson", "Kendall", "Fechner"],
    "multivariate_distribution": [
        "normal_distribution",
